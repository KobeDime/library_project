      ...
      <div class="row">
        ...
        <form action="{{url('search')}}" method="get">
          ...
          <div class="row" style="margin: 30px;">
              <div class="col-md-8">
                <input class="form-control" type="search" name="search" placeholder="Search for book title , author's name ">
              </div>
              <div class="col-md-4">        			
                <input class="btn button-8" type="submit" value="Search">
              </div>
          </div>
        </form>
        <div class="col-lg-12">
            ...
            <div class="col-lg-6 currently-market-item all msc">
              <div class="item">
                ...
                <div class="right-content">
                  ...
                  <div class="">
                    <a class="btn button-17" href="{{url('borrow_books',$data->id)}}">Apply to Borrow</a>
                  </div>
                </div>
              </div>
            </div>
